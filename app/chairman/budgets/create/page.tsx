// app/chairman/budgets/create/page.tsx
'use client';
          ...
          <div className="flex items-center justify-between">
            <Link href="/chairman/dashboard" className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-xs text-emerald-100">নতুন বাজেট তৈরি করুন</p>
              </div>
            </Link>
          </div>
        </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="bg-emerald-50 border border-emerald-200 rounded-xl p-4">
                <div className="flex">
                  ...
                  <div className="ml-3">
                    <h3 className="text-sm font-bold text-emerald-900">হ্যাশ চেইন স্বয়ংক্রিয়ভাবে তৈরি হবে</h3>
